...
Один небезизвестный архитектор сформулировал передо мной такую задачу: "можно ли написать на Go демона, который порождает армию зомби, и сколько для этого нужно убить детей, и сколько будет занимать памяти, скажем, на 1000 зомби". Да, да, формулировка прям такая xD
...
Полный код программы можно посмотреть тут: https://github.com/timursyrma/zombify
